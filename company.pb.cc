...
constexpr Company::Company(
  ...
  : addres_legal_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
...
const uint32_t TableStruct_company_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Company, addres_legal_),
  PROTOBUF_FIELD_OFFSET(::Company, name_),
  PROTOBUF_FIELD_OFFSET(::Company, occupation_),
  PROTOBUF_FIELD_OFFSET(::Company, foreign_economic_),
  3,
  0,
  1,
  2,
...
const char descriptor_table_protodef_company_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\022\024\n\014addres_legal\030\002 \002(\t\022\014\n\004name\030\003 \002(\t\022\022\n\n"
  "occupation\030\004 \001(\t\022\030\n\020foreign_economic\030\005 \001"
  "(\010"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_company_2eproto = {
  false, false, 122, descriptor_table_protodef_company_2eproto, "company.proto", 
...
class Company::_Internal {
 public:
  ...
  static void set_has_addres_legal(HasBits* has_bits) {
    (*has_bits)[0] |= 1u;
  }
  ...
  static void set_has_foreign_economic(HasBits* has_bits) {
    (*has_bits)[0] |= 16u;
  }
...
Company::Company(const Company& from)
  ...
  addres_legal_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    addres_legal_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_addres_legal()) {
    addres_legal_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, from._internal_addres_legal(), 
  ...
  ::memcpy(&year_, &from.year_,
    static_cast<size_t>(reinterpret_cast<char*>(&foreign_economic_) -
    reinterpret_cast<char*>(&year_)) + sizeof(foreign_economic_));
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&foreign_economic_) -
    reinterpret_cast<char*>(&year_)) + sizeof(foreign_economic_));
}
...
inline void Company::SharedDtor() {
  ...
  addres_legal_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
// @@protoc_insertion_point(message_clear_start:Company)
  ...
  if (cached_has_bits & 0x00000007u) {
    if (cached_has_bits & 0x00000001u) {
      addres_legal_.ClearNonDefaultToEmpty();
    }
  ...
  if (cached_has_bits & 0x00000018u) {
    ::memset(&year_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&foreign_economic_) -
        reinterpret_cast<char*>(&year_)) + sizeof(foreign_economic_));
  }
  _has_bits_.Clear();
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          auto str = _internal_mutable_addres_legal();
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          #ifndef NDEBUG
          ::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "Company.addres_legal");
          #endif  // !NDEBUG
          CHK_(ptr);
        } else
          goto handle_unusual;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 40)) {
          _Internal::set_has_foreign_economic(&has_bits);
          foreign_economic_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* Company::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000001u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::VerifyUTF8StringNamedField(
      this->_internal_addres_legal().data(), static_cast<int>(this->_internal_addres_legal().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::SERIALIZE,
      "Company.addres_legal");
    target = stream->WriteStringMaybeAliased(
        2, this->_internal_addres_legal(), target);
  }
  ...
  if (cached_has_bits & 0x00000010u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(5, this->_internal_foreign_economic(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:Company)
  ...
  if (cached_has_bits & 0x0000001fu) {
    if (cached_has_bits & 0x00000001u) {
      _internal_set_addres_legal(from._internal_addres_legal());
    }
    if (cached_has_bits & 0x00000002u) {
    ...
    if (cached_has_bits & 0x00000010u) {
      foreign_economic_ = from.foreign_economic_;
    }
...
void Company::InternalSwap(Company* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      ...
      &addres_legal_, lhs_arena,
      &other->addres_legal_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &name_, lhs_arena,
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Company, foreign_economic_)
      + sizeof(Company::foreign_economic_)
      - PROTOBUF_FIELD_OFFSET(Company, year_)>(
